...
//                            echo "<li class='show-submenu'><a href='#' tabindex='0'  class='show-submenu'>&nbsp;<span class='glyphicon glyphicon-user'></span>&nbsp;$user</a></li>";
                        ...
                        {
                            echo '<a href="./register.php" onclick="restack(currentStack)" title="Register Here"><i class="pe-7s-add-user"></i></a></li>';
