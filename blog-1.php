				...
				<div class="col-lg-9">
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="./blog-post.php"><img src="./img/blog-1.jpg" alt="" /><div class="preview"><span>Read more</span></div></a>
								</figure>
							</div>
							<div class="col-lg-5">
								<div class="post_info">
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="./blog-post.php"><img src="./img/blog-2.jpg" alt="" /><div class="preview"><span>Read more</span></div></a>
								</figure>
							</div>
							<div class="col-lg-5">
								<div class="post_info">
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="./blog-post.php"><img src="./img/blog-3.jpg" alt="" /><div class="preview"><span>Read more</span></div></a>
								</figure>
							</div>
							<div class="col-lg-5">
								<div class="post_info">
									...
									<ul>
										<li>
											<div class="thumb"><img src="./img/thumb_blog.jpg" /></div> Jessica Hoops
										</li>
										<li><i class="icon_comment_alt"></i> 20</li>
									</ul>
								</div>
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="./blog-post.php"><img src="./img/blog-4.jpg" alt="" /><div class="preview"><span>Read more</span></div></a>
								</figure>
							</div>
							<div class="col-lg-5">
								<div class="post_info">
