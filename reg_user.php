                ...
                <div id="register">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <form action="register_controller.php" method="POST" id="reg_user" name="reg_user">
                                <div class="box_form">
                                    ...
                                    <div class="form-group text-center add_top_30">
                                        <input type="hidden" value="p" name="user_type">
                                        <input class="btn_1" type="submit" value="Submit" />
                                        <a href="./register.php" class="btn_1">Back</a>
                                        <!-- <div class="btn_1" type="button" onclick="reset('p')">Back</div> -->
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                User must be at least 18 years or older to register.User is responsible for maintaining the confidentiality of the User’s account access information and password otherwise we will not be liable unauthorized use of your account.
                You are NOT allowed to DOWNLOAD or copy and make any personal, non-commercial or commercial use of the Content or information from the Application
